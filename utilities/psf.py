...
class psfSOLS(object):
    ...
    Yang, B., Lange, M., Millett-Sikking, A. et al. Nat Methods 19, 461–469 (2022).
    The code is adapted from https://github.com/royerlab/daxi/tree/master 
    """
    ...
    def _generate_zernikes(self):
        ...
        zern_n, zern_m = noll2degrees(np.arange(1, self.numZern + 1))
        return zernike(kr, theta, zern_n,zern_m)
...
if __name__ == "__main__":
    ...
    mysetup = psfSOLS(n2=1.0, na2=0.90, n3=1.525, alpha=30, size=1024, zern_mode=8, zern_coeff=0.3)
